    ...
    <ul className="faq">
      <li>
        ...
        <p>
          ...
          potential landlord. Much like a traditional resume it is a high level
          view of your background and positive characteristics. With city living
          on the rise there has never been a better time to create a rental
          resume to land the apartment of your dreams.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          here. There are no logins or ads and most importantly your information
          is never sent to or stored on a server. For your convenience, your
          resume data is saved to your browser's local storage.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          better we would love to hear your feedback. Feel free to file an issue
          on our{' '}
          <Link
